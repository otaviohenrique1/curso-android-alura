package br.com.aulaalura.agendawebservice.preferences;

import android.content.Context;
import android.content.SharedPreferences;

/**
 * Created by ROSANGELA on 24/02/2018.
 */

public class AlunoPreferences {
    private static final String ALUNO_PREFERENCES = "br.com.aulaalura.agendawebservice.preferences.AlunoPreferences";
